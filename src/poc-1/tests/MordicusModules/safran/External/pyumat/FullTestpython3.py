...
def test():
    ...
    for i in range(len(names)):
        ...
        r2 = 2
        dstran = np.array([-0.00033628699737546665,  2.1847656995628707e-05,  2.1847656995562933e-05,  r2*-0.00010904596632688759,  r2*-0.0001090459663269204 , r2*1.1680782975309023e-06])
