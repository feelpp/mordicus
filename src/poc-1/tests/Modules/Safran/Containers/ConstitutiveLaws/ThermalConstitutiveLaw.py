...
def test():
    ...
    resB1 = constitutiveLaw.ComputeCapacityVectorized(vals)
    resB2 = constitutiveLaw.ComputeConductivityVectorized(vals)
    resB3 = constitutiveLaw.ComputeInternalEnergyVectorized(vals)
