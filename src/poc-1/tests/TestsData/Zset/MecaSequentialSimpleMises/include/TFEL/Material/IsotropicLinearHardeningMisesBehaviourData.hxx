/*!
* \file   TFEL/Material/IsotropicLinearHardeningMisesBehaviourData.hxx
* \brief  this file implements the IsotropicLinearHardeningMisesBehaviourData class.
*         File generated by tfel version 4.0.0
 */

#ifndef LIB_TFELMATERIAL_ISOTROPICLINEARHARDENINGMISES_BEHAVIOUR_DATA_HXX
#define LIB_TFELMATERIAL_ISOTROPICLINEARHARDENINGMISES_BEHAVIOUR_DATA_HXX
...
class IsotropicLinearHardeningMisesBehaviourData;
...
std::ostream&
 operator <<(std::ostream&,const IsotropicLinearHardeningMisesBehaviourData<hypothesis, NumericType,false>&);

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
class IsotropicLinearHardeningMisesBehaviourData<hypothesis, NumericType,false>
{
...
friend std::ostream& operator<< <>(std::ostream&,const IsotropicLinearHardeningMisesBehaviourData&);

/* integration data is declared friend to access   driving variables at the beginning of the time step */
friend class IsotropicLinearHardeningMisesIntegrationData<hypothesis, NumericType, false>;
...
*/
IsotropicLinearHardeningMisesBehaviourData()
{}

/*!
* \brief copy constructor
*/
IsotropicLinearHardeningMisesBehaviourData(const IsotropicLinearHardeningMisesBehaviourData& src)
: eto(src.eto),
sig(src.sig),
eel(src.eel),
p(src.p),
 ...
 */
IsotropicLinearHardeningMisesBehaviourData(const mfront::gb::BehaviourData& mgb_d)
...
*/
IsotropicLinearHardeningMisesBehaviourData&
operator=(const IsotropicLinearHardeningMisesBehaviourData& src){
this->eto = src.eto;
this->sig = src.sig;
this->eel = src.eel;
this->p = src.p;
...
}; // end of IsotropicLinearHardeningMisesBehaviourDataclass

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
std::ostream&
operator <<(std::ostream& os,const IsotropicLinearHardeningMisesBehaviourData<hypothesis, NumericType, false>& b)
{
os << "εᵗᵒ : " << b.eto << '\n';
os << "σ : " << b.sig << '\n';
os << "eel : " << b.eel << '\n';
...
#endif /* LIB_TFELMATERIAL_ISOTROPICLINEARHARDENINGMISES_BEHAVIOUR_DATA_HXX */
