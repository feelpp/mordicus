...
class QuantityDefinitionDict(dict):
...
class VariabilityDefinitionDict(dict):
    """Override OrderedDict to implement visitor design pattern"""
...
class CollectionProblemData(object):
    ...
    operatorCompressionData : dict(str: OperatorCompressionDataBase)
        dictionary with solutionNames (str) as keys and data structure generated by the data compression step as values
    """
    ...
    def AddDataCompressionData(self, key, dataCompressionData):
        """
        ...
        ----------
        key : str
            solutionName for which dataCompressionData corresponds
        dataCompressionData : custom data structure
            data structure generated by the data compression step as values
        """
    ...
    def AddOperatorCompressionData(self, key, operatorCompressionData):
        """
        ...
        key : str
            solutionName for which dataCompressionData corresponds
        operatorCompressionData : OperatorCompressionDataBase
            data structure generated by the operator compression step
        """
        # self.operatorCompressionData[operatorCompressionData.GetSolutionName()] = operatorCompressionData

        assert isinstance(key, str)
        self.operatorCompressionData[key] = operatorCompressionData


    def GetOperatorCompressionData(self, key):
        """
        ...
        ----------
        key : str
            key for which operatorCompressionData corresponds
        ...
        operatorCompressionData
            custom data structure
        """
        if key not in self.operatorCompressionData:
            return None # pragma: no cover
        else:
            return self.operatorCompressionData[key]
