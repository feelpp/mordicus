...
latex_documents = [
    ('index', 'Mordicus.tex', u'Mordicus Documentation',
     Mordicus__copyright_holder__, 'manual'),
]
...
man_pages = [
    ('index', 'Mordicus', 'Mordicus Documentation',
...
texinfo_documents = [
    ('index', 'Mordicus', 'Mordicus Documentation',
     Mordicus__copyright_holder__, Mordicus__name__, 'Reduced Order Modeling',
     'Engineering'),
]
